...
public class MyNodeBuilder extends NodeBuilder {
	...
	root.add(new CreateAll(List.of(bridge, town, book, poison, 
			...
			.add(new CreateCharacterSequence(pen))
			.add(new SetPosition(pen, castleGate))
	...
	public void poisonActions() {
		...
		node.add(new NarrationSequence("The bottle was full of poison!"));
	...
	public void goToEvanActions() {
		...
		.add(new EnablePlayerOptionsSequence(List.of()))
